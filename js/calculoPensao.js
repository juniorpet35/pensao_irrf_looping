...
function calculoPensao(){
    ...
    if (pensao1 <= 0){
        ...
        outPensao.textContent = `Valor da Pensão 1: ${pensao1.toFixed(2)} - INSS ${inss} - IRRFPensaoAnterior ${pensao0}`;
    }
    ...
    if (pensao2 <= 0){
        ...
        outPensao2.textContent = `Valor da Pensão 2: ${pensao2.toFixed(2)} - INSS ${inss} - IRRFPensaoAnterior ${_irrfPensao1.toFixed(2)}`;
    }
    ...
    if (pensao3 <= 0){
        ...
        outPensao3.textContent = `Valor da Pensão 3: ${pensao3.toFixed(2)} - INSS ${inss} - IRRFPensaoAnterior ${_irrfPensao2.toFixed(2)}`;
    }
    ...
    if (pensao4 <= 0){
        ...
        outPensao4.textContent = `Valor da Pensão 4: ${pensao4.toFixed(2)} - INSS ${inss} - IRRFPensaoAnterior ${_irrfPensao3.toFixed(2)}`;
    }
    ...
    if (pensao5 <= 0){
        ...
        outPensao5.textContent = `Valor da Pensão 5: ${pensao5.toFixed(2)} - INSS ${inss} - IRRFPensaoAnterior ${_irrfPensao4.toFixed(2)}`;
    }
